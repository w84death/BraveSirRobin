...
.defines(function(){
	...
	EntityPlayer = ig.Entity.extend({
		...
		update: function() {
			...
			// POTIONS
			if(ig.input.pressed('action') && ig.game.potions.quantity > 0){

				if(this.health < this.maxHealth){
					this.health += 1;
				}
				ig.game.spawnEntity( EntityMsg, this.pos.x, this.pos.y-6, {msg:'+1 hearth', blue:true} );
				ig.game.potions.quantity -= 1;
			}
